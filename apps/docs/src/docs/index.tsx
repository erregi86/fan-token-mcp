...
// Component docs
import { AppHeaderDoc } from "./components/app-header-doc"
...
// Foundations
import { TypographyDoc } from "./foundations/typography-doc"
import { ThemingDoc } from "./foundations/theming-doc"
import { TokensDoc } from "./foundations/tokens-doc"
import { SkillGuideDoc } from "./foundations/skill-guide-doc"
...
import GeneratedDashboard from "./showcases/generated-dashboard-showcase"

const components: ComponentDoc[] = [
  // Foundations
  { slug: "tokens", name: "Design Tokens", category: "Foundations", description: "Color tokens, palettes, and semantic role mappings.", render: () => <TokensDoc /> },
  { slug: "typography", name: "Typography", category: "Foundations", description: "Font sizes, weights, line heights, and letter spacing tokens.", render: () => <TypographyDoc /> },
  { slug: "theming", name: "Theming", category: "Foundations", description: "Design token system and color customization guide.", render: () => <ThemingDoc /> },
  { slug: "skill", name: "Using the Skill", category: "Foundations", description: "Learn how to use the /fan-tokens skill for code generation and design system help.", render: () => <SkillGuideDoc /> },
  ...
  // Navigation
  { slug: "app-header", name: "App Header", category: "Navigation", description: "Top navigation header with logo, nav items, search, and actions.", render: () => <AppHeaderDoc /> },
  ...
  // Showcases
  { slug: "generated-dashboard", name: "Generated Dashboard", category: "Showcases", description: "Example dashboard generated by the /fan-tokens skill.", render: () => <GeneratedDashboard /> },
